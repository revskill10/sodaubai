...
describe "diem_chuyen_cans/new" do
  before(:each) do
    assign(:diem_chuyen_can, stub_model(DiemChuyenCan,
  ...
  it "renders new diem_chuyen_can form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", diem_chuyen_cans_path, "post" do
