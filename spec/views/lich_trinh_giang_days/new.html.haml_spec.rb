...
describe "lich_trinh_giang_days/new" do
  before(:each) do
    assign(:lich_trinh_giang_day, stub_model(LichTrinhGiangDay,
      :ma_lop => "MyString",
      :ma_mon_hoc => "MyString",
      :nam_hoc => "MyString",
      :hoc_ky => 1,
  ...
  it "renders new lich_trinh_giang_day form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", lich_trinh_giang_days_path, "post" do
