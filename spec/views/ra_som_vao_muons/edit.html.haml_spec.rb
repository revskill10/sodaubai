...
describe "ra_som_vao_muons/edit" do
  before(:each) do
  ...
  it "renders the edit ra_som_vao_muon form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", ra_som_vao_muon_path(@ra_som_vao_muon), "post" do
