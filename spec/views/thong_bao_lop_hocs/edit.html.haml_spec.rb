...
describe "thong_bao_lop_hocs/edit" do
  before(:each) do
  ...
  it "renders the edit thong_bao_lop_hoc form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", thong_bao_lop_hoc_path(@thong_bao_lop_hoc), "post" do
