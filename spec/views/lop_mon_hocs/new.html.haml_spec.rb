...
describe "lop_mon_hocs/new" do
  before(:each) do
    assign(:lop_mon_hoc, stub_model(LopMonHoc,
      :ma_lop => "MyString",
  ...
  it "renders new lop_mon_hoc form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", lop_mon_hocs_path, "post" do
