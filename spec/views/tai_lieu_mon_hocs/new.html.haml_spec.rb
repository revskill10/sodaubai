...
describe "tai_lieu_mon_hocs/new" do
  before(:each) do
    assign(:tai_lieu_mon_hoc, stub_model(TaiLieuMonHoc,
  ...
  it "renders new tai_lieu_mon_hoc form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", tai_lieu_mon_hocs_path, "post" do
